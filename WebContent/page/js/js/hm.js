(function() {
    var h = {}, mt = {}, c = {id: "effa3aa69d58f92e6887af5412a3af7b",dm: ["dingdong.ciaosir.com"],js: "tongji.baidu.com/hm-web/js/",etrk: [],icon: '',ctrk: false,align: -1,nv: -1,vdur: 1800000,age: 31536000000,rec: 0,rp: [],trust: 0,vcard: 0,qiao: 0,lxb: 0,conv: 0,med: 0,cvcc: '',cvcf: [],apps: ''};
    ...
    (function() {
        var a = mt.lang, b = h.w, f = h.load, d = {za: function(e) {
    ...
    (function() {
        ...
        var f = mt.lang, d = mt.l, e = h.w, m = h.G, n = h.ea, g = {s: [],C: 0,V: w,init: function() {
                g.e = 0;
                m.c("pv-b", function() {
                    g.fa();
                    g.ha()
                ...
                [];
                if (!a || f.d(a, "Array"))
                    window._hmt = {id: c.id,cmd: {},push: function() {
                ...
                if (a = {webim: 1,
                    tel: 2,map: 3,sms: 4,callback: 5,share: 6}[a[1]])
        ...
        try {
            if (window.performance && performance.timing && "undefined" !== typeof h.b) {
                ...
                var g = function() {
                    ...
                    g = m("navigation");
                    b = m("request");
                    g = {netAll: b.start - g.start,netDns: m("domainLookup").value,netTcp: m("connect").value,srv: m("response").start - b.start,dom: performance.timing.domInteractive - 
