...
<head>
	...
	<link rel="stylesheet" media="screen" type="text/css" href="style/pintuer.css">
...
<body>
<img src="images/0108.png" class="float-left">
			...
			<ul class="main-ul">
				...
				<li class="nav-market">
					...
					<ul class="main-nav-sub">
						<li>
							<a href="#" target="_self">会员短信群发</a>
						</li>
						<li>
							<a href="#" target="_self">导入号码群发</a>
						</li>
						<li>
							<a href="#" target="_self">优惠券群发</a>
						</li>
						<li>
				...
				<li class="nav-care">
					...
					<ul class="main-nav-sub">
						<li>
							<a href="#" target="_self">订单催付</a>
						</li>
						<li>
							<a href="#" target="_self">二次催付</a>
						</li>
						<li>
							<a href="#" target="_self">发货提醒</a>
						</li>
						<li>
							<a href="#" target="_self">到货提醒</a>
						</li>
						<li>
							<a href="#" target="_self">签收提醒</a>
						</li>
						<li>
							<a href="#" target="_self">中差评关怀</a>
						</li>
						<li>
							<a href="#" target="_self">好评关怀</a>
						</li>
						<li>
							<a href="#" target="_self">付款关怀</a>
						</li>
						<li>
							<a href="#" target="_self">迟发提醒</a>
						</li>
						<li>
							<a href="#" target="_self">回款关怀</a>
						</li>
						<li>
							<a href="#" target="_self">退款关怀</a>
						</li>
					</ul>
				</li>
			...
			<div class="index">
				<div class="clearfix">
					...
					<div id="user-info" class="border">
						<h4>欢迎 <span class="text-blue" id="shop-name">用户名</span></h4>
						<ul class="border-bottom">
							<li>剩余短信：<b class="text-dot msg-remain text-large">10</b> 条
								<a href="#" target="_self" class="button bg-yellow float-right"> 短信充值&nbsp;</a></li>
							<li>软件还剩：<b class="text-dot deadL text-large">14</b> 天
